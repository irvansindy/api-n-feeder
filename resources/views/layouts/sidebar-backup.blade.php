            ...
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item">
                    ...
                    <ul aria-expanded="false" class="collapse first-level">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link sidebar-link" href="./main/frontend-aboutpage.html"
                                aria-expanded="false">
                                <span class="rounded-3">
                                    <i class="ti ti-circle"></i>
                                </span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link sidebar-link" href="./main/frontend-blogpage.html"
                                aria-expanded="false">
                                <span class="rounded-3">
                                    <i class="ti ti-circle"></i>
                                </span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link sidebar-link" href="./main/frontend-contactpage.html"
                                aria-expanded="false">
                                <span class="rounded-3">
                                    <i class="ti ti-circle"></i>
                                </span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link sidebar-link" href="./main/frontend-pricingpage.html"
                                aria-expanded="false">
                                <span class="rounded-3">
                                    <i class="ti ti-circle"></i>
                                </span>
